...
def parse_args():
    ...
    parser.add_argument("--sentence_per_generation", type=int, default=10, help="Number of sentences to generate for each API call. Having larger number will reduce the cost, but has a risk of performance degradation.")
